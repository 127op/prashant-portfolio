  ...
  return (
    <section id="hero" className="flex flex-col items-center justify-center min-h-screen px-4 text-center text-white bg-gray-900">
      ...
      <div className="flex flex-wrap justify-center gap-3 mt-6">
        ...
        <a href="https://drive.google.com/file/d/1qvyoMmV8NKyMzp5spf42JMef6rfcPFOg/view?usp=share_link" download className="px-4 py-2 bg-green-600 rounded hover:bg-green-700">
          Veiw CV
        </a>
      </div>
